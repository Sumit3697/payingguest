...
<head>
    ...
    <title>PG for Girls Borivali West | PG Life</title>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list_mumbai.php">Mumbai</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">
            PG for Girls Borivali West Paying Guest
            </li>
        </ol>
    </nav>
    ...
    <div class="property-summary page-container">
        ...
        <div class="detail-container">
            <div class="property-name">PG for Girls Borivali West Paying Guest.</div>
