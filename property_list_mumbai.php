            ...
            <div class="content-container col-md-8">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="button-container col-6">
                        <a href="property_detail_mumbai1.php" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="button-container col-6">
                        <a href="property_detail_mumbai2.php" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="property-card row">
            ...
            <div class="content-container col-md-8">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="button-container col-6">
                        <a href="property_detail_mumbai3.php" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
        </div>
