...
<head>
    ...
    <title>PG for Girls in Laxmi Nagar | PG Life</title>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list_delhi.php">Delhi</a>
            </li>
    ...
    <div class="property-summary page-container">
        ...
        <div class="detail-container">
            <div class="property-name">PG for Girls in Laxmi Nagar Paying Guest</div>
